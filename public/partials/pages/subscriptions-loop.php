...
<div class="container">
    <div class="row">
        <div class="col-12 text-center p-5">
            <h1><?php echo __('Subscriptions', 'subscriptions') ?></h1>
        </div>
        <hr />
    </div>

    <?php do_action('before_subscriptions_loop'); ?>
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="prices-list text-center">
                        ...
                        if (get_post_meta(get_the_ID(), '_price_custom', true)) {
                            echo '<div class="custom-price-button  text-center"><strong data-address="'. get_post_meta(get_the_ID(),'_physical',true).'" data-id="' . get_the_ID() . '" data-min="' . $price_min . '" data-title="' . get_the_title() . '" class="open-price btn btn-small btn-secondary">' . __('I would like to contribute more money', 'subscriptions') . '</strong></div>';
                        }
                        ?>
                    </div>
                    <p class="d-flex justify-content-between align-items-center buttons-container">
                        <button type="button" class="btn btn-primary btn-block text-uppercase font-weight-bold button-suscribe" data-type="subscription" disabled id="button<?php echo get_the_ID() ?>" data-address="<?php echo get_post_meta(get_the_ID(),'_physical',true)?>" data-id="<?php echo get_the_ID() ?>" data-price="" data-name="<?php echo get_the_title() ?>">
    ...
    <div class="row" id="custom-price-row">
        <div class="col-12 text-center">
            ...
            <button class="btn btn-primary btn-block btn-lg" id="custom-next" data-type="subscription"><?php echo __('Next', 'subscriptions') ?></button>
        ...
        <?php if (!is_user_logged_in()) : ?>
            ...
            <div class="col-md-6 col-12 mx-auto" id="login-form-loop">
                ...
                <form method="post" class="mb-5 login-form-loop">
                    ...
                    <a href="<?php echo get_permalink(get_option('subscriptions_lost_password_page')) ?>"><?php echo __('Password Lost?', 'subscriptions') ?></a>
...
<?php else: ?>
    <div class="col-12 text-center">
        <h3><?php echo sprintf(__('Hi %s, you are already a subscriber, if you want to modify your subscription, you can do it from your profile.'), wp_get_current_user()->first_name)?></h3>
    </div>
<?php endif; ?>
